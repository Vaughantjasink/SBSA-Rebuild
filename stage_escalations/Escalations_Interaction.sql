...
FROM (
   ...
   INNER JOIN Fact_Interaction_Data ON Fact_Escalation.Result_ID = Fact_Interaction_Data.Result_ID AND Fact_Interaction_Data.', @Interaction_Filter_Column_Name, ' = "', @Filter_Value, '"
   WHERE 
