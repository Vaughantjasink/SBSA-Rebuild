SET @attributeName = 'Branch'; -- Assign attribute name 
SET @projectName = 'ATM'; -- Assign Project Name
SET @reportName = 'Achieved Purpose'; -- Assign report Name
...
SELECT
    ...
    COUNT(CASE WHEN Fact_Result_Answer.Answer_Numeric_Value = 1 THEN 1 END) / COUNT(Fact_Result.Result_ID) * 100 AS value,
